<%-- 
    Document   : ControlPed
    Created on : 24 jul. 2024, 20:52:55
    Author     : DIEGO
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="text-white flex flex-col justify-between fixed top-0 left-0 h-screen w-3/12	p-4"
            ...
            <div class="p-4">
                ...
                <nav>
                    <ul>
                        <li class="mb-5">
                            <a href="SoliDev.jsp" class="flex items-center p-2 rounded-md">
        ...
        <div class="w-9/12 h-screen overflow-y-auto p-8" style="margin-left: 25%;">
            <h1 class="text-3xl font-bold mb-8 text-[#1E415A] text-center">CONTROL PEDIDOS</h1>
