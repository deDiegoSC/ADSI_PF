<%-- 
    Document   : SoliPed
    Created on : 24 jul. 2024, 20:52:35
    Author     : DIEGO
--%>
...
<html lang="es">
    ...
    <body>
        ...
        <div class="w-9/12 h-screen overflow-y-auto p-8" style="margin-left: 25%;">
            <h1 class="text-3xl font-bold mb-8 text-[#1E415A] text-center">SOLICITUD DE PRODUCTOS</h1>
            <!--MATERIALES-->
            <div class="rounded px-16 py-10 bg-white shadow-2xl bg-gray-200 flex-col mt-5">

                <div class="m-8 bg-black-600 grid grid-cols-6 ">
                    <div class="col-start-1 col-span-2 text-2xl font-bold">Materiales a solicitar:</div>
                    ...
                    <div class=" ml-10 h-40 mt-10 border-2 border-gray-300 bg-white col-span-2 place-content-center">
                        ...
                        <div class="flex mt-5 ml-12">
                            <div class="ml-6 w-24 h-6 bg-gray-200 border-2 border-gray-300 text-center justify-center">20
                            </div>
                        ...
                        <div class="flex mt-5 ml-12">
                            <div class="ml-6 w-24 h-6 bg-gray-200 border-2 border-gray-300 text-center justify-center">10
                            </div>
                            <i class="ml-6 mt-2 fa-solid fa-square-plus fa-2xl" style="color: #ff0000;"></i>
                            <i class="ml-6 mt-2 fa-solid fa-square-minus fa-2xl" style="color: #005eff;"></i>
                        </div>
            ...
            <div class="rounded px-16 py-10 bg-white shadow-2xl bg-gray-200 flex-col mt-5">
                ...
                <div class="m-8 bg-black-600 grid grid-cols-6 ">
                    <div class="col-start-1 col-span-2 text-2xl font-bold">Herramientas a solicitar:</div>
                    <div class="col-start-6"><a href="#VentEmer" data-modal-toggle="default-modal"><button class=" bg-blue-500 text-white py-2 px-4 rounded">Agregar
                    ...
                    <div class=" ml-10 h-40 mt-10 border-2 border-gray-300 bg-white col-span-2 place-content-center">
                        ...
                        <div class="flex mt-5 ml-12">
                            <div class="ml-6 w-24 h-6 bg-gray-200 border-2 border-gray-300 text-center justify-center">7
                            </div>
                            <i class="ml-6 mt-2 fa-solid fa-square-plus fa-2xl" style="color: #ff0000;"></i>
                            <i class="ml-6 mt-2 fa-solid fa-square-minus fa-2xl" style="color: #005eff;"></i>
                        </div>
            ...
            <div class="rounded px-16 py-10 bg-white shadow-2xl bg-gray-200 flex-col mt-5">
                ...
                <div class="m-8 bg-black-600 grid grid-cols-6 ">
                    <div class="col-start-1 col-span-2 text-2xl font-bold">EPP'S a solicitar:</div>
                    ...
                    <div class=" ml-10 h-40 mt-10 border-2 border-gray-300 bg-white col-span-2 place-content-center">
                        ...
                        <div class="flex mt-5 ml-12">
                            <div class="ml-6 w-24 h-6 bg-gray-200 border-2 border-gray-300 text-center justify-center">15
                            </div>
                            <i class="ml-6 mt-2 fa-solid fa-square-plus fa-2xl" style="color: #ff0000;"></i>
                            <i class="ml-6 mt-2 fa-solid fa-square-minus fa-2xl" style="color: #005eff;"></i>
                        </div>
            ...
            <div class="text-center">
                <a href="ResumenPed.jsp"><button type="submit"
        ...
        <div id="VentEmer"
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-xl w-1/3 p-6 relative">
                <div class="mx-5 shadow-xl">
                    <h1 class="text-3xl font-bold mt-10 text-center">Agregar Producto</h1>
                    <div class="">
                        <form class="bg-white px-8 pt-6 pb-8 mb-4 font-medium rounded-lg shadow-lg" style="font-size: 130%">
                            ...
                            <div class="text-center">
                                <button type="submit" class="bg-blue-400 rounded-md text-white py-2 cursor-pointer w-full hover:bg-blue-800"
                                        name="btnIngresar">Agregar</button>
                            </div>
                        </form>
                    </div>
